...
class WH4Actor extends Actor {
  ...
  manageGroupsDialog(attribute) {
    ...
    new Dialog(
      {
        title:
          game.i18n.localize("wh4e.actor.selectGroupsFor") +
          " " +
  ...
  clearGroupsDialog(attribute) {
    ...
    new Dialog(
      {
        title:
          game.i18n.localize("wh4e.actor.clearGroupsFor") +
          " " +
          attribute.toUpperCase(),
        content: content,
        default: "ok",
  ...
  async rollInitiative(token) {
    ...
    if (!token) {
      return ui.notifications.warn(
        game.i18n.localize("wh4e.combat.noTokenForInitiative")
      );
    }
    ...
    if (!game.combat) {
      return ui.notifications.warn(
        game.i18n.localize("wh4e.combat.noActiveCombat")
      );
    }
    ...
    roll.toMessage({
      ...
      flavor:
        this.data.name + " " + game.i18n.localize("wh4e.combat.initiative"),
    });
